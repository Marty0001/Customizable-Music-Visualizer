...
class AudioBar:
    ...
    def __init__(self, x, y, freq, color='Green', width=50, min_height=1, max_height=100, min_decibel=-80, max_decibel=0, shrink_speed = 10, grow_speed = 40, angle = 0, radius = 0):
        self.x, self.y = x, y
        self.freq = freq
        self.color = color
        self.width = width
